  ...
  <div>
    ...
    <div class="grid grid-rows-2 grid-cols-2">
      <div class="w-[150px] bg-slate-200">
        <Switch v-model:switchStatus="switchStatus" :label="'開關'" :required="false" />
      </div>
      <div>
        <h2>Computer:</h2>
        <input class="w-4/6 border-2 text-right focus:outline-none" type="text" disabled>
        <div class="bg-gray-200 w-4/6">
          <div class="grid grid-rows-3 grid-cols-3 gap-5 text-center">
            <span>1</span>
            <span>2</span>
            <span>3</span>
            <span>4</span>
...
const { count } = storeToRefs(computerStore);
